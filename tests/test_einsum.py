...
class TestCase(unittest.TestCase):
    def test_einsum(self):
        ...
        expect(EIS((2,3,4),[34,-1,8]), einsum_input("i...I", (2,3,4)))
        expect(EIS((2,3,4),[34,-2,-1]), einsum_input("i...", (2,3,4)))
        ...
        expect("...I", einsum_infer_output_formula({-1:3,8:2}, [EIS((2,3),[8,-1])]))
