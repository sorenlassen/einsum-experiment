...
class TestCase(unittest.TestCase):
    ...
    def test_einsum_infer_output_subscripts(self):
        ...
        self.eq("...I", einsum_infer_output_subscripts((EIS((2,),(8,)),)))
        self.eq("...I", einsum_infer_output_subscripts((EIS((2,3),(8,-1,)),)))
        self.eq("...", einsum_infer_output_subscripts((EIS((2,2),(8,8,)),)))
        self.eq("...", einsum_infer_output_subscripts((EIS((2,),(8,)), EIS((2,),(8,)),)))
    ...
    def test_einsum_output(self):
        ...
        self.fails(lambda: einsum_output((), ".."))
        self.fails(lambda: einsum_output((), "......"))
        self.eq(EOS(()), einsum_output((EIS((2,),(8,)),), ""))
        self.eq(EOS((8,)), einsum_output((EIS((2,),(8,)),), "I"))
        self.eq(EOS((8,)), einsum_output((EIS((2,),(8,)),), None))
        self.eq(EOS((8,10,)),
            einsum_output(
                (EIS((2,3),(8,9,)), EIS((3,4),(9,10,)),), None))
        self.eq(EOS((8,10,)),
            einsum_output(
                (EIS((2,3),(8,9,)), EIS((3,4),(9,10,)),), "IK"))
        self.fails(lambda: einsum_output((), "......"))
        self.fails(lambda: einsum_output((EIS((2,),(8,)),), "II"))
    ...
    def test_einsum_execute(self):
        ...
        self.eq(t_0, einsum_execute(ES((EIS((0,),(8,)),),EOS(())),(t0_0,)))
        self.eq(t0_0, einsum_execute(ES((EIS((0,),(8,)),),EOS((8,))),(t0_0,)))
        self.eq(t_0, einsum_execute(ES((EIS((1,),(8,)),),EOS(())),(t1_0,)))
        self.eq(t1_0, einsum_execute(ES((EIS((1,),(8,)),),EOS((8,))),(t1_0,)))
